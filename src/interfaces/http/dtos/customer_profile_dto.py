...
from src.interfaces.http.dtos.employment_status_dto import EmploymentStatusDTO
...
class CustomerProfileDTO(BaseModel):
    ...
    employment_status: EmploymentStatusDTO = Field(..., description="Status de emprego")
